...
5. [Clone the salary-api repo in your instance](#clone-the-salary-api)
6. [Installation of prerequisites required for salary-api](#installation-of-prerequisites-required)
